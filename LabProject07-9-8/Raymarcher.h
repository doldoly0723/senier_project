...
//    CCamera cam;
//
//    CMaterial compositeMaterial;
//    ComputeShader raymarchCompute;
//
//    int generateNoisePass, debugNoisePass, raymarchSmokePass;
//
//    RenderTexture noiseTex, depthTex;
//    RenderTexture smokeAlbedoFullTex, smokeAlbedoHalfTex, smokeAlbedoQuarterTex;
//    RenderTexture smokeMaskFullTex, smokeMaskHalfTex, smokeMaskQuarterTex;
//
//    ComputeBuffer smokeVoxelBuffer;
//
//    RenderTexture GetSmokeAlbedoTex();
//
//    RenderTexture GetSmokeMaskTex();
//
//public:
//    void UpdateNoise();
//
